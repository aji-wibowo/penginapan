...
if (isset($_SESSION['user'])) {
	...
	if (isset($_POST['register'])) {
		...
		//Apabila semua "if" diatas terlewati maka..
			...
			if ($connect->query("INSERT INTO tamu (nik, nama_t, alamat, asal_kantor, no_tlp, email_t, username_t, password_t) VALUES ('$nik','$full_name','$address','$office_origin','$phone_number','$email','$username','$password_hash')") == true) {
	...
	<div class="card">
		<div class="card-body register-card-body">
			...
			<div class="social-auth-links text-center">
				<p>Sudah punya akun? <a href="<?=base_url()?>user/login/">Klik Disini</a></p>
			</div>
