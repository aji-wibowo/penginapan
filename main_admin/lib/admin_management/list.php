...
if (isset($_POST['add_data'])) {
	...
	$admin_domain = $connect->real_escape_string(filter($_POST['admin_domain']));
	...
	if (!$admin_username || !$admin_name || !$admin_domain || !$kd_lokasi || !$admin_email || !$admin_password1 || !$admin_password2) {
	...
	//Apabila semua "if" diatas terlewati maka..
		...
		if ($connect->query("INSERT INTO admin (username, password, nama, email, domain_kantor, kd_lokasi) VALUES ('$admin_username','$password_hash', '$admin_name', '$admin_email','$admin_domain','$kd_lokasi')") == true) {
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<form method="POST">
												...
												<div class="input-group mb-3">
													<input type="text" name="admin_domain" class="form-control" placeholder="Kantor">
													<div class="input-group-append">
														<div class="input-group-text">
