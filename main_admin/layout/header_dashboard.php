...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		<nav class="main-header navbar navbar-expand navbar-white navbar-light">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a class="nav-link">Anda login sebagai <b><?=$_SESSION['main_admin']['username']?></b> dengan role Main Admin</a>
				</li>
			</ul>
		</nav>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="<?=base_url()?>main-admin/" class="brand-link">
			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						<li class="nav-item">
							<a href="<?=base_url()?>main-admin/" class="nav-link <?php if($page == "Dashboard Admin"){ echo"active"; } ?>">
								<i class="nav-icon fas fa-tachometer-alt"></i>
								<p>Dashboard</p>
							</a>
						</li>
						<li class="nav-item">
							<a href="<?=base_url()?>main-admin/manage-rooms/" class="nav-link <?php if($page == "Daftar Kamar"){ echo"active"; } ?>">
						...
						<li class="nav-item">
							<a href="<?=base_url()?>main-admin/manage-payments/" class="nav-link <?php if($page == "Daftar Pembayaran"){ echo"active"; } ?>">
								<i class="nav-icon fas fa-hand-holding-usd"></i>
								<p>Pembayaran</p>
							</a>
						</li>
						<li class="nav-item">
							<a href="<?=base_url()?>main-admin/manage-ratings/" class="nav-link <?php if($page == "Daftar Penilaian"){ echo"active"; } ?>">
								<i class="nav-icon fas fa-star"></i>
								<p>Penilaian</p>
							</a>
						</li>
						<li class="nav-item">
							<a href="<?=base_url()?>main-admin/manage-report/" class="nav-link <?php if($page == "Daftar Laporan"){ echo"active"; } ?>">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<a href="<?=base_url()?>main-admin/logout" type="button" class="btn btn-danger" ><i class="fas fa-check btn-xs"></i> Ya, saya yakin</a>
					</div>
				</div>
				<!-- /.modal-content -->
			</div>
